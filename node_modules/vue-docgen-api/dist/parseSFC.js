...
function parseSFC(initialDoc, source, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var documentation, addScriptHandlers, parts, extTemplSrc, extTemplSource, _a, addTemplateHandlers, extSrc, extSource, _b, scriptSource, docsBlocks, docs, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    documentation = initialDoc;
                    addScriptHandlers = opt.addScriptHandlers || [];
                    parts = cacher_1.default(function () { return vue_template_compiler_1.parseComponent(source, { pad: 'line' }); }, source);
                    if (!parts.template) return [3 /*break*/, 4];
                    extTemplSrc = parts && parts.template && parts.template.attrs ? parts.template.attrs.src : '';
                    if (!(extTemplSrc && extTemplSrc.length)) return [3 /*break*/, 2];
                ...
                case 3:
                    ...
                    documentation = initialDoc || new Documentation_1.default();
                    parse_template_1.default(parts.template, documentation, __spreadArrays(template_handlers_1.default, addTemplateHandlers), opt.filePath);
                    _d.label = 4;
                case 4:
                    extSrc = parts && parts.script && parts.script.attrs ? parts.script.attrs.src : '';
                ...
                case 7:
                    ...
                    if (parts.customBlocks) {
                        documentation = documentation || new Documentation_1.default();
                    ...
                    return [4 /*yield*/, parse_script_1.default(scriptSource, script_handlers_1.preHandlers, __spreadArrays(script_handlers_1.default, addScriptHandlers), opt, documentation, initialDoc !== undefined)];
                case 8:
                    _c = (_d.sent()) || [];
                    return [3 /*break*/, 10];
                case 9:
