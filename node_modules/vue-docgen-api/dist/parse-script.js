...
function executeHandlers(preHandlers, localHandlers, componentDefinitions, documentation, ast, opt, forceSingleExport) {
    var _this = this;
    var compDefs = componentDefinitions
        .keys()
        ...
        .sort(function (_, name2) { return (name2 === 'default' ? 1 : 0); });
    ...
    return Promise.all(compDefs.map(function (name) { return __awaiter(_this, void 0, void 0, function () {
        var doc, compDef;
        var _this = this;
